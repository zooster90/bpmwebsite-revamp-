...
@section('title', 'Contact Builtech | CIDB Grade G7 Contractor — Penang, Malaysia')
@section('description', 'Get in touch with Builtech Project Management Sdn. Bhd. — Malaysia\'s trusted CIDB Grade G7 contractor in Jelutong, Penang. Call +604-659 3399 or email contact@builtech.com.my for project inquiries.')
...
@php $logoUrl = asset('img/logo.png'); $siteUrl = url('/'); @endphp
...
<div class="bt-wrapper">
    ...
    <div class="contact-stat-row">
        ...
        <div class="stat-box reveal stagger-3">
            <span class="val"><span class="counter" data-target="{{ date('Y') - 1996 }}">0</span><span>+</span></span>
        ...
        <div class="bt-container">
                    ...
                    <form action="{{ route('contact.store') }}" method="POST" novalidate>
                        ...
                        <div class="field-row">
                            <div class="field-wrap">
                                ...
                                <input type="text" id="full_name" name="full_name" placeholder="e.g. Ahmad bin Ali" required value="{{ old('full_name') }}" autocomplete="name">
                            </div>
                            <div class="field-wrap">
                                <label for="company">Company / Organisation</label>
                                <input type="text" id="company" name="company" placeholder="Your company name" value="{{ old('company') }}" autocomplete="organization">
                            </div>
                        </div>
                        <div class="field-row">
                            <div class="field-wrap">
                                <label for="email">Email Address <span style="color:#e53e3e;">*</span></label>
                                <input type="email" id="email" name="email" placeholder="you@company.com" required value="{{ old('email') }}" autocomplete="email">
                            </div>
                            <div class="field-wrap">
                                <label for="phone">Phone Number <span style="color:#e53e3e;">*</span></label>
                                <input type="tel" id="phone" name="phone" placeholder="+60 12-345 6789" required value="{{ old('phone') }}" autocomplete="tel">
                            </div>
                        </div>
                        <div class="field-wrap">
                            ...
                            <select id="service_type" name="service_type">
                                ...
                                <option value="project_management" {{ old('service_type')=='project_management'?'selected':'' }}>Project Management</option>
                                <option value="building_civil" {{ old('service_type')=='building_civil'?'selected':'' }}>Building &amp; Civil Works</option>
                                <option value="industrial" {{ old('service_type')=='industrial'?'selected':'' }}>Industrial Building</option>
                                <option value="maintenance" {{ old('service_type')=='maintenance'?'selected':'' }}>Maintenance Services</option>
                                <option value="property" {{ old('service_type')=='property'?'selected':'' }}>Property Development</option>
                                <option value="safety_training" {{ old('service_type')=='safety_training'?'selected':'' }}>Safety &amp; Health Training</option>
                        ...
                        <div class="field-wrap">
                            ...
                            <textarea id="message" name="message" placeholder="Briefly describe your project: location, scale, scope, and timeline..." required>{{ old('message') }}</textarea>
                        </div>
            ...
            <div class="map-wrapper reveal" style="margin-top:5rem;">
                ...
                <div style="min-height:480px;">
                    {{--
                        MAP PIN: Builtech Project Management Sdn. Bhd.
                        Verified coordinates: 5.39190°N, 100.30330°E
                        Place ID: ChIJ4TwXkQpDRjER4KkNQmb5wmM
                        Address: 17H Lebuhraya Batu Lanchang, 11600 Jelutong, Penang
                    --}}
                    {{--
                        PINNED: Builtech Project Management Sdn. Bhd.
                        Google Place ID: ChIJ4TwXkQpDRjER4KkNQmb5wmM
                        Coords: 5.39190°N, 100.30330°E
                        Address: 17H Lebuhraya Batu Lanchang, 11600 Jelutong, Penang
                        Format: search-pin embed (forces red marker on exact building)
                    --}}
                    <iframe
