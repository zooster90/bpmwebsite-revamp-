...
@section('title', 'Corporate Governance | Vision, Mission & Quality Commitments | Builtech')
@section('description', 'Builtech Project Management\'s corporate governance framework — our Vision, Mission, guiding principles, and ISO-certified quality commitments. Established 1996, CIDB Grade G7.')
...
<div class="bt-wrapper">
        ...
        <div class="bt-container">
            <div class="bt-quality-card reveal">
                ...
                <div class="bt-cert-row">
                    <div class="bt-cert-mini" onclick="openGlobalLightbox('{{ asset('img/images/SGS_ISO 9001 - DSM Mark_TCL_LR.jpg') }}')">
                    ...
                    <div class="bt-cert-mini" onclick="openGlobalLightbox('{{ asset('img/images/SGS_ISO 45001 DSM Mark_TCL_LR.jpg') }}')">
                    ...
                    <div class="bt-cert-mini" onclick="openGlobalLightbox('{{ asset('img/images/ISO_14001_Latest.jpg') }}')">
    ...
    <section class="bt-section py-64 bg-navy relative overflow-hidden">
        ...
        <div class="bt-container relative z-10 text-center reveal">
            ...
            <a href="{{ route('sustainability') }}" class="bt-btn bt-btn-primary !px-16 !py-6">Sustainability Commitment</a>
        </div>
    </section>
</div>
@endsection