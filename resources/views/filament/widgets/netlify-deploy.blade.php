<x-filament-widgets::widget>
    {{-- Robust Scoped CSS Styles for Visual Stability --}}
    <style>
        .nd-card {
    ...
    <div class="nd-card" @if ($deployStatus === 'running') wire:poll.1s="checkForUpdates" @endif>
        {{-- Custom Scoped Header --}}
        <div class="nd-header">
            <div>
            ...
            <div class="nd-badges">
                ...
                <span class="nd-badge-time">
                    Last Sync: <span style="font-family: monospace; font-weight: 700; margin-left: 4px;">{{ $lastDeployTime }}</span>
                </span>
            </div>
        </div>

        {{-- 3-Column Bento Grid with Scoped Styling --}}
        <div class="nd-grid">
        ...
        {{-- Deployment Action Box --}}
        <div class="nd-action-box">
            @if ($deployStatus === 'idle' || $deployStatus === 'success' || $deployStatus === 'failed')
                <button 
                    wire:click="deploy" 
            ...
            @elseif ($deployStatus === 'running')
                {{-- Dynamic Running Spinner --}}
        ...
        @if ($deployLog)
            <div style="margin-top: 20px;">
                ...
                <div class="nd-terminal-body" x-data x-init="$el.scrollTop = $el.scrollHeight" x-effect="$el.scrollTop = $el.scrollHeight">
                    <pre class="nd-terminal-pre">{{ $deployLog }}</pre>
                </div>
            </div>
        @endif
    </div>
