@extends('layouts.app')
@section('title', 'Industry Resources | Builtech Project Management')
    ...
    <div class="links-grid">
        ...
        <a href="https://www.cidb.gov.my" target="_blank" class="link-card reveal delay-100">
            <div class="link-logo-container">
                <img src="{{ asset('img/images/cidb_logo-768x250.png') }}" alt="CIDB Malaysia">
            </div>
            <h3>CIDB Malaysia</h3>
        ...
        <a href="https://www.jkr.gov.my" target="_blank" class="link-card reveal delay-200">
            <div class="link-logo-container">
                <img src="{{ asset('img/images/t_500x300.jpg') }}" alt="JKR Malaysia">
            </div>
            <h3>JKR Malaysia</h3>
        ...
        <a href="https://www.mbpp.gov.my" target="_blank" class="link-card reveal delay-300">
            <div class="link-logo-container">
                <img src="{{ asset('img/images/OIP (1).jpg') }}" alt="MBPP Penang">
            </div>
            <h3>MBPP</h3>
        ...
        <a href="https://www.mbsp.gov.my" target="_blank" class="link-card reveal delay-400">
            <div class="link-logo-container">
                <img src="{{ asset('img/images/OIP.jpg') }}" alt="MBSP Penang">
            </div>
            <h3>MBSP</h3>
