...
@section('title', $service->title . ' | Builtech Services')
    ...
    <div class="service-content-wrapper">
        <div class="bt-container">
            <div class="service-content-container reveal">
                <a href="{{ route('services.index') }}" class="back-btn"><i class="fas fa-arrow-left"></i> Back to Services</a>
                ...
                <div class="service-body">
                    @if($service->content)
                        {!! $service->content !!}
                    @else
                        <p>Detailed information about {{ $service->title }} will be updated soon. Please check back later or contact us directly for inquiries.</p>
                        <div style="margin-top:2rem;">
                            <a href="{{ route('contact') }}" class="bt-btn bt-btn-primary">Contact Us</a>
                        </div>
                    @endif
                </div>
            </div>
