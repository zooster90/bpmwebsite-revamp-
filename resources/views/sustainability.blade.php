...
@section('title', 'Sustainability | ESG Commitment & ISO Certification | Builtech')
@section('description', 'Builtech\'s commitment to Environmental, Social & Governance (ESG) excellence. Triple ISO certified — 9001, 45001, 14001 — for quality, safety and environmental responsibility since 1996.')
...
<div class="bt-wrapper">
        ...
        <div class="bt-container">
            <div class="bt-csr-split">
                <div class="reveal">
                    ...
                    <a href="{{ route('culture') }}#csr" class="bt-btn bt-btn-primary">Explore CSR Activities</a>
                </div>
                <div class="reveal delay-200">
                    <div class="bt-csr-media">
                        <img src="{{ asset('img/images/csr_collage.jpg') }}" alt="CSR Activities Collage">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="bt-section bg-white">
        <div class="bt-container">
            ...
            <div class="bt-cert-grid">
                {{-- ISO 9001 --}}
                <div class="reveal" data-delay="0">
                    <div class="bt-cert-card" onclick="openGlobalLightbox('{{ asset('img/images/SGS_ISO 9001 - DSM Mark_TCL_LR.jpg') }}')">
                        <img src="{{ asset('img/images/SGS_ISO 9001 - DSM Mark_TCL_LR.jpg') }}" alt="ISO 9001">
                        <h4>ISO 9001:2015</h4>
                ...
                {{-- ISO 45001 --}}
                <div class="reveal" data-delay="150">
                    <div class="bt-cert-card" onclick="openGlobalLightbox('{{ asset('img/images/SGS_ISO 45001 DSM Mark_TCL_LR.jpg') }}')">
                        <img src="{{ asset('img/images/SGS_ISO 45001 DSM Mark_TCL_LR.jpg') }}" alt="ISO 45001">
                ...
                {{-- ISO 14001 --}}
                <div class="reveal" data-delay="300">
                    <div class="bt-cert-card" onclick="openGlobalLightbox('{{ asset('img/images/ISO_14001_Latest.jpg') }}')">
                        <img src="{{ asset('img/images/ISO_14001_Latest.jpg') }}" alt="ISO 14001">
    ...
    <section class="bt-section py-64 bg-navy relative overflow-hidden">
        ...
        <div class="bt-container relative z-10 text-center reveal">
            ...
            <a href="{{ route('our-people') }}" class="bt-btn bt-btn-primary !px-16 !py-6">Meet Our People</a>
        </div>
    </section>
</div>
@endsection
