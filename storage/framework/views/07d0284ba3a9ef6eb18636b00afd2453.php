...
<nav class="navbar <?php echo e($isLightBg ? 'navbar-dark-text' : ''); ?>" id="mainNav">
    <div class="navbar-inner">
        <a href="/" class="navbar-logo">
            <img src="<?php echo e(asset('img/logo.png')); ?>" alt="Builtech Logo" class="logo-img">
        </a>

        <ul class="nav-menu">
            <li><a href="/" class="nav-link <?php echo e($currentRoute == 'home' ? 'active' : ''); ?>">Home</a></li>
            
            <li class="dropdown">
                <a href="<?php echo e(route('about')); ?>" class="nav-link <?php echo e(in_array($currentRoute, ['about', 'our-people', 'story']) ? 'active' : ''); ?>">
                    ...
                    <div class="dropdown-grid" style="grid-template-columns: 1fr 1fr 1fr;">
                        <div class="dropdown-column">
                            ...
                            <div class="nested-items">
                                <a href="<?php echo e(route('corporate')); ?>">Corporate Governance</a>
                                <a href="<?php echo e(route('story')); ?>">Our Legacy</a>
                                <a href="<?php echo e(route('our-people')); ?>">Leadership Team</a>
                            </div>
                        </div>
                        <div class="dropdown-column">
                            <a href="<?php echo e(route('sustainability')); ?>">
            ...
            <li><a href="<?php echo e(route('services.index')); ?>" class="nav-link <?php echo e($currentRoute == 'services.index' ? 'active' : ''); ?>">Expertise</a></li>
            <li><a href="<?php echo e(route('projects.index')); ?>" class="nav-link <?php echo e(str_contains($currentRoute, 'projects') ? 'active' : ''); ?>">Portfolio</a></li>
            <li><a href="<?php echo e(route('news.index')); ?>" class="nav-link <?php echo e(str_contains($currentRoute, 'news') ? 'active' : ''); ?>">Journal</a></li>
            <li><a href="<?php echo e(route('careers')); ?>" class="nav-link <?php echo e($currentRoute == 'careers' ? 'active' : ''); ?>">Careers</a></li>
            
            <li>
                <a href="<?php echo e(route('contact')); ?>" class="btn-contact-nav">
                    Contact Us
                </a>
            </li>
        </ul>
...
<div class="mobile-sidebar" id="mobileSidebar">
    <div class="sidebar-header">
        <img src="<?php echo e(asset('img/logo.png')); ?>" alt="Builtech" class="mobile-logo">
    ...
    <div class="sidebar-content">
        ...
        <div class="mobile-section">
            ...
            <a href="<?php echo e(route('our-people')); ?>">
        ...
        <div class="mobile-section">
            ...
            <a href="<?php echo e(route('culture', ['category' => 'intern'])); ?>">
    ...
    <div class="sidebar-footer">
        <a href="<?php echo e(route('contact')); ?>" class="mobile-contact-btn">
...
<div class="mobile-bottom-nav" id="mobileBottomNav">
    <a href="<?php echo e(route('projects.index')); ?>" class="bottom-nav-item <?php echo e(str_contains($currentRoute, 'projects') ? 'active' : ''); ?>">
        <i class="fa-solid fa-city"></i>
        <span>PROJECTS</span>
    </a>

    <a href="<?php echo e(route('services.index')); ?>" class="bottom-nav-item <?php echo e($currentRoute == 'services.index' ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('contact')); ?>" class="bottom-nav-item <?php echo e($currentRoute == 'contact' ? 'active' : ''); ?>">
...
<?php /**PATH C:\Users\built\Herd\builtech-app\resources\views/partials/navbar.blade.php ENDPATH**/ ?>