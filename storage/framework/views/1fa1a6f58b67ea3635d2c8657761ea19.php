<?php $__env->startSection('title', 'Our Story | The Engineering Legacy Since 1996 | Builtech'); ?>
<?php $__env->startSection('description', 'Discover the engineering legacy of Builtech Project Management. From our 1996 genesis to CIDB Grade G7 authority, we build with precision and integrity — We Built To Last.'); ?>
        ...
        <div class="bt-container">
            <div class="layered-genesis">
                <div class="reveal">
                    ...
                    <img src="<?php echo e(asset('img/webuiltolast.png')); ?>" alt="We Built To Last" style="max-width: 320px; margin-bottom: 2.5rem; filter: brightness(0) invert(0.1);">
                    ...
                    <div class="flex gap-10">
                        <div class="text-center">
                            <div class="text-4xl font-display font-black text-navy mb-1"><span class="counter" data-target="<?php echo e(date('Y') - 1996); ?>">0</span>+</div>
                ...
                <div class="genesis-media reveal delay-200">
                    <img src="<?php echo e(asset('img/images/retro_6_grid_collage.jpg')); ?>" alt="Legacy Collage" class="genesis-main-img">
        ...
        <div class="bt-container relative z-10">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
                <div class="reveal">
                    ...
                    <a href="<?php echo e(route('our-people')); ?>" class="bt-btn bt-btn-primary !px-12">Meet Our People</a>
                </div>
                <div class="culture-grid reveal delay-200">
                    ...
                    ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $galleryImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="culture-img-wrapper" onclick="openGlobalLightbox('<?php echo e(asset($img)); ?>')">
                            <img src="<?php echo e(asset($img)); ?>" alt="Culture Image">
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\built\Herd\builtech-app\resources\views/story.blade.php ENDPATH**/ ?>