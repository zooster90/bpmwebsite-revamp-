<?php $__env->startSection('title', 'Our Services | Builtech Project Management'); ?>
<?php $__env->startSection('description', 'Builtech offers end-to-end construction services including project management, building & civil works, industrial buildings, maintenance, property development and safety training.'); ?>
    ...
    <section class="bt-section" style="background:white;">
        <div class="bt-container">
            ...
            <div class="service-grid">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php $stagger = ($idx % 3) + 1; ?>
                    <a href="<?php echo e(route('services.show', $service->slug)); ?>" class="service-card reveal stagger-<?php echo e($stagger); ?>" style="text-decoration:none;">
    ...
    <section class="bt-section" style="background:white; text-align:center;">
        <div class="bt-container reveal" style="max-width:800px;">
            ...
            <div style="display:flex; gap:1rem; justify-content:center; flex-wrap:wrap;">
                <a href="<?php echo e(route('contact')); ?>" class="btn-primary"><i class="fas fa-envelope"></i> Contact Us Now</a>
                <a href="<?php echo e(route('projects.index')); ?>" class="btn-primary btn-navy"><i class="fas fa-folder-open"></i> See Our Portfolio</a>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\built\Herd\builtech-app\resources\views/services.blade.php ENDPATH**/ ?>