<?php $__env->startSection('title', 'Careers | Join Builtech — Malaysia Grade G7 Engineering Team'); ?>
<?php $__env->startSection('description', 'Explore career opportunities at Builtech Project Management Sdn. Bhd. Join Malaysia\'s leading CIDB Grade G7 contractor based in Penang.'); ?>
...
<div class="bt-wrapper" x-data="{ showForm: <?php echo e(($errors->any() || session('success')) ? 'true' : 'false'); ?>, selectedJob: '' }">
    ...
    <div class="career-stats">
        ...
        <div class="career-stat-box reveal stagger-1">
            <span class="val"><span class="counter" data-target="<?php echo e($yrs); ?>">0</span><span>+</span></span>
        ...
        <div class="career-stat-box reveal stagger-3">
            <span class="val"><span class="counter" data-target="<?php echo e(count($jobs ?? [])); ?>">0</span><span>+</span></span>
    ...
    <section id="open-positions" class="bt-section" style="background:var(--off-white);">
        <div class="bt-container">
            ...
            <div style="display:grid; grid-template-columns:repeat(auto-fit,minmax(340px,1fr)); gap:2rem;">
                ...
                <div class="job-card reveal" data-delay="<?php echo e($loop->index * 80); ?>">
                    <div class="job-dept"><i class="fas fa-layer-group"></i> <?php echo e($job->department ?? 'Engineering'); ?></div>
                    <h3 class="job-title"><?php echo e($job->title); ?></h3>
                    <div class="job-meta">
                        <span class="job-tag"><i class="fas fa-map-marker-alt" style="color:var(--gold);"></i> <?php echo e($job->location ?? 'Penang, Malaysia'); ?></span>
                        <span class="job-tag"><i class="fas fa-briefcase" style="color:var(--gold);"></i> <?php echo e($job->type ?? 'Full-Time'); ?></span>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->closing_date): ?>
                            <span class="job-tag urgent"><i class="fas fa-clock"></i> Closes <?php echo e(\Carbon\Carbon::parse($job->closing_date)->format('d M Y')); ?></span>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->description): ?>
                        <p class="job-desc"><?php echo e(Str::limit($job->description, 180)); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <button
                        @click="selectedJob='<?php echo e(addslashes($job->title)); ?>'; showForm=true; $nextTick(()=>{ document.getElementById('pos_input').value='<?php echo e(addslashes($job->title)); ?>'; document.getElementById('job_id_input').value='<?php echo e($job->id); ?>'; })"
        ...
        <div class="bt-container">
            ...
            <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(280px,1fr)); gap:1.5rem;">
                ...
                <div class="benefit-card reveal">
                    <div class="benefit-icon"><i class="<?php echo e($icon); ?>"></i></div>
                    <div>
                        <h4 style="font-family:'Oswald',sans-serif; font-size:1.1rem; font-weight:700; color:var(--navy); text-transform:uppercase; margin-bottom:0.4rem;"><?php echo e($title); ?></h4>
                        <p style="font-size:0.92rem; color:var(--text-muted); line-height:1.75; margin:0;"><?php echo e($desc); ?></p>
                    </div>
                </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </div>
    ...
    <section class="process-section bt-section">
        <div class="bt-container">
            ...
            <div class="process-grid">
                ...
                ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$num, $title, $desc]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <div class="process-item reveal stagger-<?php echo e($loop->index + 1); ?>">
                    <div class="process-step-circle"><?php echo e($num); ?></div>
                ...
                <form action="<?php echo e(route('careers.apply')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div style="display:grid; grid-template-columns:1fr 1fr; gap:1.5rem;" class="form-grid">
                        <div class="field-wrap">
                            ...
                            <input type="text" id="name_input" name="name" placeholder="e.g. Ahmad bin Ali" required value="<?php echo e(old('name')); ?>">
                        </div>
                        <div class="field-wrap">
                            <label for="email_input">Email Address <span style="color:#e53e3e;">*</span></label>
                            <input type="email" id="email_input" name="email" placeholder="you@example.com" required value="<?php echo e(old('email')); ?>">
                        </div>
                        <div class="field-wrap">
                            <label for="pos_input">Position Applied For <span style="color:#e53e3e;">*</span></label>
                            <input type="text" id="pos_input" name="position" placeholder="e.g. Site Engineer" required value="<?php echo e(old('position')); ?>">
                        </div>
                        <div class="field-wrap">
                            <label for="phone_input">Contact Number <span style="color:#e53e3e;">*</span></label>
                            <input type="tel" id="phone_input" name="phone" placeholder="+60 12-345 6789" required value="<?php echo e(old('phone')); ?>">
                        </div>
                        <div class="field-wrap">
                            <label>Expected Monthly Salary (RM)</label>
                            <input type="text" name="expected_salary" placeholder="e.g. RM 5,000 – RM 7,000" value="<?php echo e(old('expected_salary')); ?>">
                        </div>
                        <div class="field-wrap">
                            <label>Earliest Available Date</label>
                            <input type="text" name="availability" placeholder="e.g. Immediate / 2 Weeks Notice" value="<?php echo e(old('availability')); ?>">
                        </div>
                    </div>

                    <div class="field-wrap">
                        <label>Cover Letter / Why should we hire you?</label>
                        <textarea name="cover_letter" placeholder="Briefly describe your relevant experience, key achievements, and what value you bring to Builtech..."><?php echo e(old('cover_letter')); ?></textarea>
                    </div>
    ...
    <section class="bt-section" style="background:white; text-align:center;" x-show="!showForm">
        <div class="bt-container reveal" style="max-width:700px;">
            ...
            <div style="display:flex; gap:1rem; justify-content:center; flex-wrap:wrap;">
                ...
                <a href="<?php echo e(route('contact')); ?>" class="btn-primary btn-navy">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\built\Herd\builtech-app\resources\views/careers.blade.php ENDPATH**/ ?>