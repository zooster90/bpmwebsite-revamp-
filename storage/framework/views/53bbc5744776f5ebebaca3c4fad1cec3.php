<?php $__env->startSection('title', 'Document Center | Builtech Downloads'); ?>
<?php $__env->startSection('description', 'Access Builtech corporate credentials, safety policies, quality certifications, and vendor registration forms.'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <main class="dl-container">
        ...
        <section class="dl-section reveal">
            ...
            <div class="dl-grid">
                <a href="<?php echo e(asset('assets/builtech-profile.pdf')); ?>" class="dl-card" download>
                ...
                <a href="<?php echo e(asset('assets/cidb-g7-cert.pdf')); ?>" class="dl-card" download>
                    <div class="dl-icon"><i class="fas fa-file-pdf"></i></div>
                    <div class="dl-info">
                ...
                <a href="<?php echo e(asset('assets/iso-certificates.pdf')); ?>" class="dl-card" download>
                    <div class="dl-icon"><i class="fas fa-file-pdf"></i></div>
                    <div class="dl-info">
        ...
        <section class="dl-section reveal">
            ...
            <div class="dl-grid">
                <a href="<?php echo e(asset('assets/safety-policy.pdf')); ?>" class="dl-card" download>
                ...
                <a href="<?php echo e(asset('assets/environmental-policy.pdf')); ?>" class="dl-card" download>
        ...
        <section class="dl-section reveal">
            ...
            <div class="dl-grid">
                <a href="<?php echo e(asset('assets/vendor-registration.pdf')); ?>" class="dl-card" download>
                ...
                <a href="<?php echo e(asset('assets/internship-form.pdf')); ?>" class="dl-card" download>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\built\Herd\builtech-app\resources\views/downloads.blade.php ENDPATH**/ ?>