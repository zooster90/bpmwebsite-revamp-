<?php $__env->startSection('title', 'Our People | Builtech Project Teams'); ?>
<?php $__env->startSection('description', 'Meet the specialized project teams and corporate workforce behind Builtech\'s Grade G7 engineering excellence in Malaysia.'); ?>
...
<div class="bt-wrapper">
    ...
    <div class="bt-ppl-nav-wrap">
        <nav class="bt-ppl-nav">
            <a href="<?php echo e(route('story')); ?>">Our Story</a>
            <a href="<?php echo e(route('corporate')); ?>">Governance</a>
            <a href="<?php echo e(route('sustainability')); ?>">Sustainability</a>
            <a href="<?php echo e(route('our-people')); ?>" class="active">Our People</a>
        </nav>
    </div>
    ...
    <section style="background:white; padding:80px 0 100px;">
        <div class="bt-container">
            ...
            <div style="display:grid; grid-template-columns:repeat(auto-fill, minmax(350px, 1fr)); gap:2.5rem;">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php
                        $imgSrc = $t->displayImage ?: asset('img/logo.png');
                    ?>
                    <div class="reveal" data-delay="<?php echo e(($index % 4) * 80); ?>">
                        <div class="bt-team-card">
                            
                            <a href="<?php echo e($imgSrc); ?>"
                               class="glightbox"
                               data-gallery="team-photos"
                               data-title="<?php echo e($t->title); ?>"
                               data-description="<?php echo e($t->department); ?>"
                               style="display:block; text-decoration:none;">
                                <div class="bt-team-img-wrap">
                                    <img src="<?php echo e($imgSrc); ?>"
                                         alt="<?php echo e($t->title); ?> — Builtech Project Management"
                                         loading="lazy">
                                    
                                    <div class="bt-team-overlay">
                                        <span class="bt-team-overlay-label"><?php echo e($t->department); ?></span>
    ...
    <section style="background:var(--navy); padding:100px 5%; position:relative; overflow:hidden;">
        ...
        <div class="bt-container relative z-10 text-center reveal">
            ...
            <p style="font-size:1.05rem; color:rgba(255,255,255,0.65); max-width:560px; margin:0 auto 2.5rem; line-height:1.85;">
                We are always looking for technical pioneers to join our <?php echo e(date('Y') - 1996); ?>-year legacy of engineering excellence.
            </p>
            <a href="<?php echo e(route('careers')); ?>" class="btn-primary">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\built\Herd\builtech-app\resources\views/our-people.blade.php ENDPATH**/ ?>