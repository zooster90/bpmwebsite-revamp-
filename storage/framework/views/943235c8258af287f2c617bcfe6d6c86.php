<?php $__env->startSection('title', 'Press & Media | Builtech in the News'); ?>
<?php $__env->startSection('description', 'Explore Builtech media coverage and press mentions. Documenting our growth and achievements in the construction industry through leading publications.'); ?>
    ...
    <section class="media-section">
        ...
        <div style="text-align:center; margin-bottom:3.5rem;">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $years; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $year): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <button class="year-btn" onclick="filterByYear('<?php echo e($year); ?>', this)"><?php echo e($year); ?></button>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </div>
        </div>

        <div class="media-grid">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $coverages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <div class="media-card reveal year-<?php echo e($item->published_date->format('Y')); ?>">
                    <div class="media-image-wrapper">
                        <a href="<?php echo e($item->display_image); ?>"
                           class="glightbox"
                           data-gallery="media-press"
                           data-title="<?php echo e($item->headline); ?>"
                           data-description="<?php echo e($item->publication); ?> &middot; <?php echo e($item->published_date->format('d M Y')); ?>"
                           style="display:block; width:100%; height:100%;">
                            <img src="<?php echo e($item->display_image); ?>" alt="<?php echo e($item->headline); ?>" class="media-image" loading="lazy">
                    ...
                    <div class="media-info">
                        <span class="media-publication"><?php echo e($item->publication); ?></span>
                        <h3 class="media-headline"><?php echo e($item->headline); ?></h3>
                        <div class="media-date">
                            <i class="far fa-calendar-alt text-gold"></i>
                            <?php echo e($item->published_date->format('d M Y')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\built\Herd\builtech-app\resources\views/media.blade.php ENDPATH**/ ?>