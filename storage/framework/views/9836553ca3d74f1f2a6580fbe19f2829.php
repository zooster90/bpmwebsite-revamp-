<?php $__env->startSection('title', 'Builtech | We Built To Last'); ?>
...
<style>
    ...
    .team-img-bg {
        flex: 1 1 50%;
        min-height: 400px;
        background: url('<?php echo e(asset('img/images/Welcome _ Builtech Project Management_files/22(3).jpg')); ?>') center/cover no-repeat;
    }
...
<div class="bt-wrapper">
    ...
    <header class="hero">
        <div class="hero-slider">
            ...
            <div class="slide" style="background-image: url('<?php echo e(asset('img/images/Aston Acasia.jpeg')); ?>');"></div>
            <div class="slide" style="background-image: url('<?php echo e(asset('img/images/Aston Acacia,Bukit Mertajam,Penang.jpg')); ?>');"></div>
        </div>
        <div class="hero-overlay"></div>
        <div class="hero-content reveal">
            <span class="main-slogan">CIDB Grade 7 Certified</span>
            <h1><img src="<?php echo e(asset('img/webuiltolast.png')); ?>" alt="We Built To Last"></h1>
            <p class="sub-slogan">
            ...
            <div style="margin-top: 45px;"><a href="<?php echo e(route('services.index')); ?>" class="btn-primary">OUR EXPERTISE</a></div>
        </div>
    ...
    <section class="big-4-section">
        <div class="stats-grid">
            ...
            <div class="stat-item reveal stagger-2">
                ...
                <div class="stat-value"><span class="counter" data-target="<?php echo e(date('Y') - 1996); ?>">0</span>+</div>
        ...
        <div class="bt-container" style="max-width: 1320px; margin: 0 auto;">
            <div class="management-grid">
                ...
                <div class="reveal" style="position: relative">
                    <img src="<?php echo e(asset('img/images/istockphoto-838476004-612x612.jpg')); ?>" class="management-img" alt="Builtech Construction">
    ...
    <section class="section-padding bg-off-white">
        ...
        <div class="modern-horizontal-scroll scrollbar-none">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $flagships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <a href="<?php echo e(route('projects.show', $p->slug)); ?>" class="project-card reveal group">
                    ...
                    <img src="<?php echo e($p->display_image); ?>" alt="<?php echo e($p->title ?? $p->name); ?>" loading="lazy">
                    <div class="project-info relative z-20">
                        <p style="color:#c5a059; font-size:0.75rem; letter-spacing:2.5px; font-weight:800; text-transform:uppercase;"><?php echo e($p->location); ?></p>
                        <h4 style="font-family:'Oswald', sans-serif; font-size:1.8rem; margin-top:8px;"><?php echo e($p->title ?? $p->name); ?></h4>
                    </div>
                </a>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            
            <a href="<?php echo e(route('projects.index')); ?>" class="all-records-card reveal">
                ...
                <p style="color: var(--gold); font-weight: 800; font-size: 1.2rem; letter-spacing: 1.5px; text-transform: uppercase;"><?php echo e(date('Y') - 1996); ?> Years of Success</p>
            </a>
        </div>
    </section>

    <!-- ========== CURRENT DEVELOPMENTS ========== -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($ongoingProjects) && count($ongoingProjects) > 0): ?>
    <section class="section-padding bg-white">
        ...
        <div class="bt-container">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $ongoingProjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $op): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="bg-white rounded-xl overflow-hidden shadow-lg border border-gray-100 hover:-translate-y-2 transition-transform duration-300 reveal group">
                        <div class="relative h-60 overflow-hidden">
                            ...
                            <img src="<?php echo e($op->display_image ?? asset('img/images/placeholder.jpg')); ?>" alt="<?php echo e($op->title ?? $op->name); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                        </div>
                        <div class="p-6">
                            <span class="text-gold font-bold text-[10px] uppercase tracking-[0.2em] mb-2 block"><?php echo e($op->category?->name ?? 'Construction'); ?></span>
                            <h3 class="font-heading text-lg text-navy font-bold mb-2 leading-tight" style="font-family: 'Oswald', sans-serif;"><?php echo e($op->title ?? $op->name); ?></h3>
                            <div class="text-gray-500 text-xs flex items-center gap-2 mt-4 font-medium">
                                <i class="fa-solid fa-map-marker-alt text-gold"></i> <?php echo e($op->location ?? 'Malaysia'); ?>
        ...
        <div class="bt-container text-center">
            ...
            <div class="iso-container" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 35px; margin-top: 60px;">
                <div class="iso-card reveal stagger-1" style="background: var(--off-white); padding: 45px; border-radius: 20px; transition: var(--transition-premium); border: 1px solid #eee;">
                    ...
                    <div class="iso-img-wrapper"><img src="<?php echo e(asset('img/images/SGS_ISO 9001 - DSM Mark_TCL_LR.jpg')); ?>" alt="ISO 9001" style="height: 60px; margin-bottom: 20px;"></div>
                ...
                <div class="iso-card reveal stagger-2" style="background: var(--off-white); padding: 45px; border-radius: 20px; transition: var(--transition-premium); border: 1px solid #eee;">
                    ...
                    <div class="iso-img-wrapper"><img src="<?php echo e(asset('img/images/SGS_ISO 45001 DSM Mark_TCL_LR.jpg')); ?>" alt="ISO 45001" style="height: 60px; margin-bottom: 20px;"></div>
                ...
                <div class="iso-card reveal stagger-3" style="background: var(--off-white); padding: 45px; border-radius: 20px; transition: var(--transition-premium); border: 1px solid #eee;">
                    ...
                    <div class="iso-img-wrapper"><img src="<?php echo e(asset('img/images/ISO_14001_Latest.jpg')); ?>" alt="ISO 14001" style="height: 60px; margin-bottom: 20px;"></div>
    ...
    <section class="bg-off-white" style="padding: 130px 5% 110px;">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($latest_news) && count($latest_news) > 0): ?>
        <div class="bt-container">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $latest_news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 reveal border border-gray-100 group">
                        <div class="relative h-64 overflow-hidden">
                            <img src="<?php echo e($news->display_image); ?>" alt="<?php echo e($news->title); ?>" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
                        </div>
                        <div class="p-8 text-left">
                            <span style="display:block; font-size:0.8rem; font-weight:700; color:var(--gold); text-transform:uppercase; letter-spacing:0.12em; margin-bottom:0.5rem;">
                                <?php echo e($news->published_date ? \Carbon\Carbon::parse($news->published_date)->format('d M Y') : 'Recent Update'); ?>

                            </span>
                            <h3 style="font-family:'Oswald',sans-serif; font-size:1.3rem; font-weight:700; color:var(--navy); margin-bottom:0.8rem; line-height:1.25;"><?php echo e($news->title); ?></h3>
                            <p style="font-size:0.95rem; color:#4b5563; line-height:1.75; margin-bottom:1.2rem;"><?php echo e(Str::limit(strip_tags($news->content), 120)); ?></p>
                            <a href="<?php echo e(route('news.show', $news->slug)); ?>" style="font-size:0.8rem; font-weight:800; color:var(--navy); text-transform:uppercase; letter-spacing:0.15em; display:inline-flex; align-items:center; gap:8px;" class="hover:text-gold transition-colors">
            ...
            <div class="text-center reveal">
                <a href="<?php echo e(route('news.index')); ?>" class="btn-primary" style="background: var(--navy); border-radius: 50px;">CLICK TO EXPLORE ARCHIVE</a>
            </div>
        </div>
        <?php else: ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($latestMedia) && count($latestMedia) > 0): ?>
        <div class="bt-container mt-32">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $latestMedia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <a href="<?php echo e($media->external_url ?? '#'); ?>" target="_blank" class="bg-white rounded-xl p-8 border border-gray-100 hover:border-gold hover:shadow-xl transition-all duration-300 reveal group block text-left">
                    <span class="text-gold font-bold text-xs uppercase tracking-widest mb-3 block"><?php echo e($media->publication ?? 'Press'); ?> &bull; <?php echo e($media->published_date ? \Carbon\Carbon::parse($media->published_date)->format('d M Y') : ''); ?></span>
                    <h3 class="font-heading text-lg text-navy font-bold mb-4 line-clamp-2 leading-tight" style="font-family: 'Oswald', sans-serif;"><?php echo e($media->headline); ?></h3>
                    <p class="text-gray-600 text-sm mb-6 line-clamp-2" style="font-family: 'Montserrat', sans-serif;"><?php echo e($media->excerpt); ?></p>
            ...
            <div class="text-center reveal">
                <a href="<?php echo e(route('news.index')); ?>" class="btn-primary" style="background: var(--navy); border-radius: 50px;">CLICK TO VIEW ALL PRESS</a>
            </div>
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </section>
    ...
    <section class="section-padding bg-navy text-white relative overflow-hidden">
        ...
        <div class="bt-container relative z-10">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <a href="<?php echo e(route('story')); ?>" class="group block p-8 rounded-xl bg-white/5 border border-white/10 hover:border-gold hover:bg-white/10 transition-all duration-300 reveal text-center" style="text-decoration:none;">
                ...
                <a href="<?php echo e(route('sustainability')); ?>" class="group block p-8 rounded-xl bg-white/5 border border-white/10 hover:border-gold hover:bg-white/10 transition-all duration-300 reveal delay-100 text-center" style="text-decoration:none;">
                ...
                <a href="<?php echo e(route('careers')); ?>" class="group block p-8 rounded-xl bg-white/5 border border-white/10 hover:border-gold hover:bg-white/10 transition-all duration-300 reveal delay-200 text-center" style="text-decoration:none;">
                ...
                <a href="<?php echo e(route('contact')); ?>" class="group block p-8 rounded-xl bg-white/5 border border-white/10 hover:border-gold hover:bg-white/10 transition-all duration-300 reveal delay-300 text-center" style="text-decoration:none;">
    ...
    <section class="team-section">
        ...
        <div class="team-content">
            ...
            <div><a href="<?php echo e(route('our-people')); ?>" class="btn-primary reveal delay-300" style="background: var(--gold); color: var(--navy); font-weight: 800; border: none; padding: 1rem 2.5rem; border-radius: 5px;">MEET THE TEAM</a></div>
        </div>
    </section>
    ...
    <section class="final-cta" style="padding: 130px 5%; text-align: center; background: linear-gradient(135deg, var(--gold) 0%, var(--gold-dark) 100%);">
        <div style="max-width: 900px; margin: 0 auto; position: relative; z-index: 2;">
            ...
            <a href="<?php echo e(route('contact')); ?>" class="btn-primary" style="background: var(--navy); color: white; padding: 1.5rem 5rem; font-size: 1.1rem; border-radius: 60px;">CONTACT OUR EXPERTS</a>
        </div>
    </section>
</div>
<?php $__env->stopSection(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\built\Herd\builtech-app\resources\views/welcome.blade.php ENDPATH**/ ?>