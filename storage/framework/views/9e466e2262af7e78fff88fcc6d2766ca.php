...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Builtech Project Management | CIDB Grade G7 Contractor'); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('description', 'Grade G7 Engineering & Construction Excellence since 1996. Delivering complex industrial and commercial landmarks across Malaysia.'); ?>">
    <meta name="robots" content="index, follow" />
    <link rel="canonical" href="<?php echo e(url()->current()); ?>" />

    
    <meta property="og:title"       content="<?php echo $__env->yieldContent('title', 'Builtech Project Management'); ?>">
    <meta property="og:description" content="<?php echo $__env->yieldContent('description', 'CIDB G7 Construction Excellence since 1996.'); ?>">
    ...
    <meta property="og:image:alt"    content="<?php echo $__env->yieldContent('title', 'Builtech'); ?> — Builtech Engineering Malaysia">
    <?php else: ?>
    ...
    <meta name="twitter:title"       content="<?php echo $__env->yieldContent('title', 'Builtech Project Management'); ?>">
    <meta name="twitter:description" content="<?php echo $__env->yieldContent('description', 'CIDB G7 Construction Excellence since 1996.'); ?>">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($ogImage) && $ogImage): ?>
    <meta name="twitter:image"       content="<?php echo e($ogImage); ?>">
    <?php else: ?>
    <meta name="twitter:image"       content="<?php echo e(asset('img/logo.png')); ?>">
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    
    <link rel="icon"       type="image/png" sizes="32x32" href="<?php echo e(asset('img/logo.png')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/builtech.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/global-design.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/global-fix.css')); ?>?v=<?php echo e(time()); ?>">
...
</html><?php /**PATH C:\Users\built\Herd\builtech-app\resources\views/layouts/app.blade.php ENDPATH**/ ?>