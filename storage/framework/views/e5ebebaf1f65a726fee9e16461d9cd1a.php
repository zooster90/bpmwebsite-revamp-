<?php $__env->startSection('title', $article->title . ' | The Builtech Journal'); ?>
<?php $__env->startSection('description', Str::limit(strip_tags($article->excerpt ?? $article->content), 160)); ?>
...
<div class="bt-wrapper bg-white">
    ...
    <header class="bt-article-header">
        <div class="bt-article-container reveal">
            <div class="bt-article-meta">
                <span><?php echo e($article->category?->name ?? 'Journal'); ?></span>
                <span class="sep"></span>
                <span style="color:var(--bt-text-muted)"><?php echo e($date); ?></span>
            </div>
            <h1 class="bt-article-title bt-title"><?php echo e($article->title); ?></h1>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($article->author): ?>
                <div class="flex items-center gap-4">
                    ...
                    <span class="text-xs font-bold uppercase tracking-widest text-navy">By <?php echo e($article->author); ?></span>
                </div>
    ...
    <main class="bt-article-container pb-32">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($img): ?>
            <img src="<?php echo e($img); ?>" alt="<?php echo e($article->title); ?>" class="bt-article-hero reveal" onclick="openGlobalLightbox(this.src)">
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($galleryItems) > 0): ?>
            <section class="mt-24 reveal">
                ...
                <div class="bt-gallery-grid">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $galleryItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        ...
        <footer class="bt-article-footer reveal">
            <a href="<?php echo e(route('news.index')); ?>" class="bt-btn bt-btn-outline !border-navy/10 !text-navy hover:!bg-navy hover:!text-white">
                <i class="fa-solid fa-arrow-left-long mr-3"></i> Return to Journal
            </a>
            <div class="flex gap-4">
                <a href="https://www.linkedin.com/sharing/share-offsite/?url=<?php echo e(urlencode(request()->url())); ?>" target="_blank" class="w-12 h-12 rounded-full border border-gray-100 flex items-center justify-center text-navy hover:bg-gold hover:text-white hover:border-gold transition-all">
                    <i class="fa-brands fa-linkedin-in"></i>
                </a>
                <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(request()->url())); ?>&text=<?php echo e(urlencode($article->title)); ?>" target="_blank" class="w-12 h-12 rounded-full border border-gray-100 flex items-center justify-center text-navy hover:bg-gold hover:text-white hover:border-gold transition-all">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\built\Herd\builtech-app\resources\views/news-detail.blade.php ENDPATH**/ ?>